...
screen main_menu():
    ...
    fixed:
        ...
        imagebutton:
            idle "gui/button/TutorialButton.png"
            action Jump("tutorial_label")
            xpos 13 
            ypos 225
            focus_mask True
...
screen tutorial_screen():
    tag menu
    modal True
    add "images/Backgrounds/Tutorial.png"
    
    fixed:
        # Imagebutton for playing the video.
        imagebutton:
            idle "gui/button/TutorialScreen.png"
            action Play("movie", "tutorial.mp4")
            xpos -1
            ypos -34
            focus_mask True
...
screen level_selection_screen():
    ...
    add "images/UI/LevelSelection.png"
...
screen level_3_preview():
    ...
    add "images/UI/MansionLevel.png"
...
screen level_4_preview():
    ...
    add "images/UI/ApartmentLevel.png"
...
screen sublevel_hut_screen():
    tag menu
    modal True
    add "images/UI/SublevelHut.png"  # Background for Hut sublevels

    fixed:
        # Sublevel 1 button
        imagebutton:
            idle "gui/button/Sublevel1Button.png"
            action Jump("puzzle_start")
            xpos -656
            ypos -45
            #xysize (150, 100)
            focus_mask True
...
screen sublevel_house_screen():
    tag menu
    modal True
    add "images/UI/SublevelHouse.png"  # Background for House sublevels
    ...
    fixed:
        ...
        imagebutton:
            idle "gui/button/Sublevel5Button.png"
...
screen mansion_sublevel1_screen():
    tag menu
    modal True
    add "images/UI/MansionSublevel1.png"  # UI for first page (sublevels 1-5)
    ...
    fixed:
        ...
        imagebutton:
            idle "gui/button/NextButton.png"
...
screen mansion_sublevel2_screen():
    tag menu
    modal True
    add "images/UI/MansionSublevel2.png"  # UI for second page (sublevels 6-8)

    fixed:
        # Three sublevel buttons for sublevels 6 to 8
        imagebutton:
            idle "gui/button/Sublevel6Button.png"
        ...
        imagebutton:
            idle "gui/button/Sublevel7Button.png"
        ...
        imagebutton:
            idle "gui/button/Sublevel8Button.png"
        ...
        imagebutton:
            idle "gui/button/PreviousButton.png"
...
screen apartment_sublevel1_screen():
    tag menu
    modal True
    add "images/UI/ApartmentSublevel1.png"  # UI for first page (sublevels 1-5)
...
screen apartment_sublevel2_screen():
    tag menu
    modal True
    add "images/UI/ApartmentSublevel2.png"  # UI for second page (sublevels 6-8)
