# init python:
#     class grid:
#         def __init__(self, grid_size, icons_per_row, icon_padding, icon_size):
#             self.icons_list = []
...
#         def setup_icons(self, grid_size,):

#     class icons:
#         def __init__(self):
            
#     class level:
#         def __init__(self, score, moves, base_points, target_score):
#             self.score = score
#             self.moves = moves
...
#         global score
#         #Calculates the score multiplied based on number of matches
...
#         print(score, "=", round(base_points * (len(matches) + multiplier)))
...
#             print(round(score * (moves//score + 1)))
#             #Score is calculated on the end based on the number of moves left
...
#     $ frame_ySize = ((grid_size // icons_per_row) * icon_size) + ((grid_size // icons_per_row) * icon_padding) + 6
